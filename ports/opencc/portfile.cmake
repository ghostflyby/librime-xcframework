...
set(opencc_builds_target_tools ON)
set(opencc_options
...
if(DEFINED VCPKG_CMAKE_SYSTEM_NAME AND VCPKG_CMAKE_SYSTEM_NAME STREQUAL "iOS")
    set(opencc_builds_target_tools OFF)
...
if("tools" IN_LIST FEATURES AND opencc_builds_target_tools)
